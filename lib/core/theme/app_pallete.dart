...
class AppPallete {
  ...
  static const Color accentOrange = tertiaryContainer; // Custom accent mapping (#8B2E01)
...
class AppRadius {
  ...
  static const BorderRadius borderDefault = BorderRadius.all(Radius.circular(defaultValue));
