class AppRoutes {
  ...
  static const requestCredits = '/profile/request';
  static const creditRequests = '/profile/requests';
  ...
  static String requestCreditsPath() => '/profile/request';
  static String creditRequestsPath() => '/profile/requests';
}
